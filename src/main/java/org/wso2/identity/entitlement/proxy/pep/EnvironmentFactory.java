...
/**
 * EnvironmentFactory creates an instance of {@link AzEntity}<
 * {@link AzCategoryIdEnvironment}>, which is
 ...
 * 
 */
public class EnvironmentFactory extends RequestAttributesFactoryImpl<AzCategoryIdEnvironment> {
	...
	public Environment createObject(PepRequest pepRequestContext) {
		...
		AzEntity<AzCategoryIdEnvironment> env =
		                                        ctx.createAzEntity(AzCategoryIdEnvironment.AZ_CATEGORY_ID_ENVIRONMENT);
		ctx.addAzEntity(env);
