...
public class ObligationImpl 
    ...
    /**
     * Returns a Set of Obligation Attribute name,value pairs,
     * indexed by name, where the value is a string representation
     * of the runtime object that represents Obligation "attribute".
     * @return a map of Obligation Attribute name,value(string) pairs
     */
    public Map<String,String[]> getAttributeStringValues() {
    	// TBD: implement
    ...
    /**
     * Returns a Set of Obligation Attribute name,value pairs,
     * indexed by name, where the "value" is the actual Object
     * instance that represents the Obligation "attribute".
     * @return a map of Obligation Attribute name,value(object) pairs
     */
    public Map<String,Object[]> getAttributeObjectValues() {
    	// TBD: implement
